	                ...
	                <div class="row">
	                   <div class="col-md-12">
                            <div class="well" style="background: #ffffff;">
                                <button onclick="setupEditorModal('new')" data-toggle='modal'  data-target='#editorModal'  class ='btn btn-primary'><i  class='fa fa-plus'></i> Add new Department</button>
                                <hr class=""/>
                                <form method="POST" action="department.php">
                                     <?php echo $dept->getDepartments();?>
                                </form>
	                            ...
	                            <div class="card-content">
	                                <form id="editor_form" method="post" action="cod.php">
	                                    ...
	                                    <div class="row">	                                        
	                                        <div class="col-md-12">
												<div class="form-group label-floating">
													<label class="control-label">Department_no</label>
													<input id="dept_no" name="dept_no" type="text" class="form-control" >
												</div>
	                                        </div>                                            
	                                    ...
	                                    <div class="row">
	                                      <div class="col-md-12">
												<div class="form-group label-floating">
													<label class="control-label">Faculty/School/Institute</label>
     ...
     <script type="text/javascript">
            function setupEditorModal(purpose){                
                if(purpose === 'new'){
                    ...
                    $('#id_editor_modal_footer').html("<button type='button' onclick=\"add_record('dept')\" class='btn btn-primary'><i class='fa fa-save'></i> Save Record</button><button type='button' class='btn btn-danger btn-simple' data-dismiss='modal'>Close</button>");
                }else{
                    $('#id_editor_modal_title').html("Edit record");
                    $('#id_editor_modal_footer').html("<button type='button' onclick=\"edit_record('dept')\" class='btn btn-info'><i class='fa fa-save'></i> Update Changes</button><button type='button' class='btn btn-danger btn-simple' data-dismiss='modal'>Close</button>");
