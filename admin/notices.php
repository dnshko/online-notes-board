...
<body>
	                ...
	                <div class="row">
	                   <div class="col-md-12">
                            <div class="well" style="background: #ffffff;">
                                <button onclick="setupEditorModal('new')" data-toggle='modal'  data-target='#editorModal'  class ='btn btn-primary'><i  class='fa fa-plus'></i> Add new notice</button>
                                <hr class=""/>
                              
                                <?php echo $ntc->getAllNotices();?>
    ...
    <div class="modal fade" id="editorModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <form id="editor_form" method="post" action="./notices.php" enctype="multipart/form-data">
	                            ...
	                            <div class="card-content">
                                        ...
                                        <div class="row">
                                             <?php 
                                                ...
                                                $random_notice ="NTC";
                                                $current_user =$_SESSION['current_user']." (ADMINISTRATION)";
                                                $time = time();                                                
    	...
    	<div class="modal-dialog">
    		<div class="modal-content">
    			...
    			<div class="modal-footer">        
      	             <a id="link" class="btn btn-info "><span class="fa fa-envelope"></span> Mail notice to Students</a>        
            ...
            function setupEditorModal(purpose){
                    if(purpose === 'new'){
                       ...
                       $('#id_editor_modal_title').html("Add new record");
                        ...
                        $('#id_editor_modal_footer').html("<button type='button' onclick=\"edit_record('note')\" class='btn btn-primary'><i class='fa fa-save'></i> Update Changes</button><button type='button' class='btn btn-danger btn-simple' data-dismiss='modal'>Close</button>");
